...
/* harmony default export */ var appupdate = ({
  ...
  methods: {
    ...
    appsure: function () {
      ...
      this.form.vMustUpdate = this.form.vMustUpdate == true ? "1" : "0";
      // api.uploadApp(this.form.appName,this.form.appVersion,16,this.form.terminalType,this.form.updateRemark,this.form.vMustUpdate,this.$refs.upfile.value)
      // .then(res=>{
      ...
      instance.post('version/uploadAPP', formData).then(res => {
