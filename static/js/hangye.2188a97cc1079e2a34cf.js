...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./src/page/setting/hangye.vue
//
//
//
//
...
/* harmony default export */ var hangye = ({
  data() {
  ...
  mounted() {
    api["a" /* default */].hangyeList(1, 0).then(res => {
  ...
  methods: {
    ...
    surehyClick: function () {
      api["a" /* default */].editIndustry(this.select_hy.induId, this.form.name, 0).then(res => {
        if (this.select_hy.induName) {
          this.select_hy.induName = this.form.name;
        } else {
          api["a" /* default */].hangyeList(1).then(res => {
            this.list = res.data.lists;
          });
        }
...
/* harmony default export */ var page_setting_hangye = __webpack_exports__["default"] = (Component.exports);
