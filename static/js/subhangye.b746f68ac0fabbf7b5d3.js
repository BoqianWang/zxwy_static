...
/* harmony default export */ var subhangye = ({
  ...
  mounted() {
    api["a" /* default */].hangyeList(1, 1, this.$route.query.Id).then(res => {
  ...
  methods: {
    ...
    surehyClick: function () {
      api["a" /* default */].editIndustry(this.select_hy.induId, this.form.name, 1, this.$route.query.Id).then(res => {
